...
<html>
   ...
   <body style="text-align:center; background-color:#D8C6B7;">
    ...
    <div class="navbar"><a></a> </div>
    <br>
    
<marquee style="color:#09192F; font-size:25px;" width="60%" direction="right" height="100px" scrollamount="20.4"><h1 class="multicolortext"><b>Logging off</b></h1></marquee>
<br>
<marquee style="color:#ff4000; font-size:25px;" width="60%" direction="left" height="100px" scrollamount="21.4"><h1 class="multicolortext"><b>Please wait . . . . !</b></h1></marquee>
<br><br><br><hr color="#22075E" width="1000px;">

...
<html>
    ...
    <body style="text-align:center; background-color:#D8C6B7;">
        <%IBT ibt = (IBT)request.getAttribute("IBT");%>
    ...
    <br>
        ...
        <input type="text" name="id" value="<%=ibt.getId()%>" hidden>
        <label>Product Code: <input type="text" name="prodCode" value="<%=ibt.getProductCode()%>" readonly></label>   <br>
        <label>Requesting Boutique: <input type="text" name="requestingB" value="<%=ibt.getRequestingBoutique()%>" readonly></label>   <br>
        <input type="submit" name="submit" value="approveIBT">
        <input type="submit" name="submit" value="rejectIBT">
        </form>

...
<body style="text-align:center; background-color:#D8C6B7;">
    ...
    <form id="form">
        <input type="radio" value="sale" name="type" id="type1">Sales</option>
        <input type="radio" value="rating" name="type" id="type2">Rating</option>
        <br><br>
...
<script>
    ...
    var chartType;
            ...
            function getSalesReport() {
                ...
                xhr.open("POST", "http://localhost:8080/carolsBoutiqueRest/CarolsBoutique/report/findTopStoresInTermsOfSales", true);
            ...
            function getRatingReport() {
                ...
                xhr.open("POST", "http://localhost:8080/carolsBoutiqueRest/CarolsBoutique/report/findHighestRatedStores", true);
                xhr.setRequestHeader("Content-Type", "application/json");
                xhr.onreadystatechange = (function (_this) {
                    return function () {
                        if (xhr.readyState == 4 && xhr.status == 200) {
